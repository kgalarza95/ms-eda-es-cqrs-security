...
import ec.com.sofka.responses.exception.InsufficientBalanceException;
import ec.com.sofka.responses.exception.ResourceNotFoundException;
...
public class SaveTransactionUseCase implements IUseCaseExecute<CreateTransactionRequest, CreateTransactionResponse> {
